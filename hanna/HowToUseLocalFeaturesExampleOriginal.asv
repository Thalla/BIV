...
%tform = affine2d([1 0 0; 0.1 1 0; 0 0 1]);
%J = imwarp(J,tform);
theta = 65;
...
[featuresDistorted,validPtsDistorted] = extractFeatures(distorted,ptsDistorted);
    ...
    plot(validPtsOriginal.selectStrongest(10),'showOrientation',true);
    figure; imshow(distorted); hold on;
    plot(validPtsDistorted.selectStrongest(10),'showOrientation',true);
%%
